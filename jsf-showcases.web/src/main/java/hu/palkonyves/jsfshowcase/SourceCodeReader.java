...
public class SourceCodeReader {
	 ...
	 */
	public String getFileSource(String pageName) throws IOException {
		if (pageName == null) {
			throw new RuntimeException(
					"pageName must not be null for getFileSource(pageName)");
		}
	 ...
	 * @return
	 */
	public String getSnippet(String pageName, String number) throws IOException {
		if (pageName == null) {
			throw new RuntimeException(
					"pageName must not be null for getSnippet(pageName)");
		}
		if (number == null) {
