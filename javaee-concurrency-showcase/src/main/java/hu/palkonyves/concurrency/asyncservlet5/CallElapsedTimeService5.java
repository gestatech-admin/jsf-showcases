...
public class CallElapsedTimeService5 implements Callable<Long> {
	private static Logger LOG = Logger.getLogger(CallElapsedTimeService5.class.getName());
	
    private final ConfigurationService configurationService;
    

    CallElapsedTimeService5(ConfigurationService configurationService) {
