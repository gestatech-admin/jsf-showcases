...
public class CallElapsedTimeService4 implements Callable<Long> {
	private static Logger LOG = Logger.getLogger(CallElapsedTimeService4.class.getName());
	
    private final ConfigurationService configurationService;
    

    CallElapsedTimeService4(ConfigurationService configurationService) {
