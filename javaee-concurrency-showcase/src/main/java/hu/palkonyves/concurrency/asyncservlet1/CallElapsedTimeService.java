...
public class CallElapsedTimeService implements RunnableFuture<Long> {
	private static Logger LOG = Logger.getLogger(CallElapsedTimeService.class.getName());
	
    private final ConfigurationService configurationService;
    private Long elapsedTime = null;

    CallElapsedTimeService(ConfigurationService configurationService) {
    ...
    public void run() {
        ...
        LOG.info(Thread.currentThread().getName() + " elapsedTime=" + elapsedTime);
